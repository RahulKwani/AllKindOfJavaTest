...
public class GCommunitySample {
  private static final Logger logger = Logger.getLogger(GCommunitySample.class);
  ...
  private static final MeasureDouble M_READ_LATENCY_MS =
      MeasureDouble.create("btapp/read_latency", "The latency in milliseconds for read", "ms");

  // [START config_oc_write_latency_measure]
  // The write latency in milliseconds
  private static final MeasureDouble M_WRITE_LATENCY_MS =
      MeasureDouble.create("btapp/write_latency", "The latency in milliseconds for write", "ms");
  // [END config_oc_write_latency_measure]

  // Counts the number of transactions
  private static final MeasureLong M_TRANSACTION_SETS =
      MeasureLong.create("btapp/transaction_set_count", "The count of transactions", "1");
  ...
  private static void registerMetricViews() {
    ...
    Aggregation latencyDistribution =
        Distribution.create(
            BucketBoundaries.create(
                Arrays.asList(0.0, 5.0, 10.0, 25.0, 100.0, 200.0, 400.0, 800.0, 10000.0)));
    ...
    View[] views =
        new View[] {
          View.create(
              Name.create("btappmetrics/read_latency"),
          ...
          View.create(
              Name.create("btappmetrics/write_latency"),
          ...
          View.create(
              Name.create("btappmetrics/transaction_set_count"),
    ...
    for (View view : views) manager.registerView(view);
  }
